...
winSize= .413;
[sp,fp,tp]= DSP.Calc_Spectrogram(xSignal, fois, fs, winSize, winSize/2, "STFT",[]);
figure
nexttile
plot(time,xSignal)
xlabel("time")
...
subplot(3,1, 3);
slt1 = faslt(xSignal, fs, fois, 1, [5,40], 0);
imagesc(time, fois, slt1);
set(gca, 'ydir', 'normal');
colormap jet;
